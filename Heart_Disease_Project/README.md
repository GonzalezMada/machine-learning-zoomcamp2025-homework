...
Make sure you have already trained the model (run `python train.py` first to generate `model.bin`).
...
Once the container is running, you can test it using any of the methods described in the "Make Predictions" section above.
